...
const phases = [
  {
    ...
    duration: "6 Weeks",
    image:
      "https://cdn.iconscout.com/icon/premium/png-512-thumb/setting-167-243672.png",
  },
  {
    id: "2",
    phase: "Phase 2",
                  ...
                  <div className={"rowx"}>
                    ...
                    <div className={"cardsxc"}>
                      ...
                      <div className={"cardtext"}>
                        {item.campaign.numberOfInfluencers}
                      </div>
                    </div>
                    <div className={"cardsxc"}>
                      ...
                      <div className={"rowx"}>
                        <div className={"colic"} style={{ marginLeft: -2 }}>
                          ...
                          />{" "}
                          {item.campaign.task.facebook}
                        </div>
                        <div className={"colic"}>
                          <InstagramIcon
                            style={{ color: pink[300], width: 30, height: 30 }}
                          />{" "}
                          {item.campaign.task.instagram}
                        </div>
                      </div>
                      <div className={"rowx"}>
                        <div className={"colic"}>
                          ...
                          />{" "}
                          {item.campaign.task.youtube}
                        </div>
                        <div className={"colic"}>
                          <TwitterIcon style={{ color: blue[500] }} />{" "}
                          {item.campaign.task.twitter}
                        </div>
                      </div>
                    </div>
                  </div>
...
export default class JobScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    axios({
      method: "POST",
      url: `http://localhost:5000/api/u/jobs`, // First page at 0
      data: databit,
      headers: {
  ...
  render() {
    return <JobScreenfunct window={window} Jobs={this.state.Jobs} />;
  }
}
