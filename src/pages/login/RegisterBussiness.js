...
class RegisterBussiness extends Component {
  ...
  handleSelect = (e) => {
    var msDiff =
      new Date(e.endDate).getTime() - new Date(e.startDate).getTime(); //Future date - current date
  ...
  handleContinue = (e) => {
    if (
      this.state.nameAndSurname === null ||
  ...
  handleSubmit = (e) => {
    ...
    if (this.state.duration === null || this.state.description === null) {
      ...
      axios({
        method: "POST",
        url: `http://localhost:5000/api/brand/new`,
        data: this.state,
      }).then((res) => {
        this.props.history.push("/wb");
      });
    }
  };
  render() {
    return (
      <div className="authBox">
        <div className="leftBoxBusiness">
          ...
          <div className="imageBusinessAuth"></div>
        </div>
        <div className="rightBoxBusiness">
          <div className="bgRed">
            ...
            <div className="regplaceBusiness">Contact Us</div>
            <div>
                  ...
                  <div className="logininput2">
                    ...
                    <div className="inputRegibox">
                      <Select
                        ...
                        defaultValue={{
                          label:
                            "Has your brand used Influencer Marketing before?",
                          value: "default-value",
                        }}
                ...
                {this.state.part === 2 && (
                  <div className="logininput2">
                    ...
                    <textarea
                      ...
                      name="description"
                      onChange={this.handleChange}
                      style={{ heiht: 110, fontSize: 14 }}
                      multiline
                      className="inputRegibox"
                      placeholder="Description of Campaign"
                    />
                    <input
                      value={this.state.influencers}
                      type="Number"
                      name="influencers"
                      onChange={this.handleChange}
                      className="inputRegibox"
                    ...
                    <textarea
                      ...
                      multiline
                      className="inputRegibox"
                      placeholder="Do's for influencers"
                    />
                    <textarea
                      value={this.state.donts}
                      type="text"
                      name="donts"
                      onChange={this.handleChange}
                      style={{ height: 80, fontSize: 14 }}
                      multiline
                      className="inputRegibox"
                      placeholder="Dont's for influencers"
                    />
                    <div className="tc">
                      <div>
