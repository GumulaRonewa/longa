...
const Posts = (feed) => {
  ...
  const [value, setValue] = React.useState(
    true ? "fas fa-heart pink" : "fas fa-heart"
  );
  ...
  const handlePost = () => {
    ...
    var use =
      sessionStorage.getItem("surname") + " " + sessionStorage.getItem("name");
    console.log(use);
    console.log("top");
    ...
    axios({
      method: "POST",
      url: `http://localhost:5000/api/feed/comment`, // First page at 0
      data: form,
      headers: {
  ...
  const handleClick = () => {
    ...
    if (value !== "null") {
      ...
      axios({
        method: "POST",
        url: `http://localhost:5000/api/feed/like`, // First page at 0
        data: databit,
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token")}`,
        },
      ...
      <div className="post-box">
        <div className="profile-nav">
          <div className="user-box">
            <Avatar style={{ width: 40, height: 40 }} src={"L"} alt={"L"} />
            <div>
        ...
        <div className="video-container">
          ...
          <div className="likes-box">
            ...
            <span style={{ color: "white" }} className="likes-span">
              {feeds[4]} likes.
            </span>
