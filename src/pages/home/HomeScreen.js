...
function HomeScreenfunct(props) {
  ...
  const handleBid = () => {
    ...
    axios({
      method: "POST",
      url: `http://localhost:5000/api/bid`, // First page at 0
      data: databid,
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
  ...
  const renderBankingMenu = (
    ...
    >
      <div style={{ height: 400, width: 300 }}>
        {!payment && !MoMo && (
          <div>
            <StyledButton onClick={handlePayment}>Add Bank Card</StyledButton>
        ...
        {payment && (
          <div>
            <div style={{ fontSize: 20 }}>
              ...
              you receive payment for Campaings you participate in. Make sure
              the details below are correct and up to date. These details are
              stored securely in our system and will never be shared with third
              parties.
            </div>
            ...
            <TextField
              ...
              variant="outlined"
              name={"Bn"}
              style={{ left: 10, right: 10, width: 280 }}
            />
            <p style={{ "font-size": "18px", paddingLeft: 3 }}>
              {" "}
              Account Number*:
            </p>
            <TextField
            ...
            {selectedPromo === "all" && (
              <div className={"homelistdivexplore"}>
                <div className={"cardsxe"}>
                  <ListItem>
                    <Avatar
                      style={{ height: 80, width: 80, left: 4, top: 4 }}
                      src={"L"}
                      alt={"L"}
                    />
                    ...
                    <ListItemIcon>
                      <IconButton
                        onClick={handleExpandButtonClick(item, 1)}
                        className={
                      ...
                      >
                        <ArrowForwardIosIcon
                          style={{ marginLeft: 5, height: 40, width: 30 }}
                        />
                      </IconButton>
                    </ListItemIcon>
                  </ListItem>
                ...
                <div className={"rowx"}>
                  <div className={"cardsx"}>
                    ...
                    <div>
                      {" "}
                      <GroupIcon style={{ height: 70, width: 70 }} />
                    </div>
                  ...
                  <div className={"cardsxc"}>
                    ...
                    <div className={"rowsz"}>
                      <div className={"colic"} style={{ marginLeft: -2 }}>
                        <FacebookIcon
                          style={{ color: blue[400], width: 30, height: 30 }}
                        />{" "}
                        {item.task.facebook}
                      </div>
                      <div className={"colic"}>
                        <InstagramIcon
                          style={{ color: pink[300], width: 30, height: 30 }}
                        />{" "}
                        {item.task.instagram}
                      </div>
                    </div>
                    <div className={"rowsz"}>
                      <div className={"colic"}>
                        <YouTubeIcon
                          style={{ color: red[500], width: 30, height: 30 }}
                        />{" "}
                        {item.task.youtube}
                      </div>
                      <div className={"colic"}>
              ...
              <div className={"homelistdivexplore"}>
                <div className={"cardsxe"}>
                  <ListItem>
                    ...
                    <div className={"large"}>
                      ...
                      <ListItemIcon>
                        <button
                          ...
                          className={
                            item.bidders.includes(
                              sessionStorage.getItem("userId")
                            ) || bids.includes(selectedPromo)
                              ? "buttonsexpandgreen"
                              : "buttonsexpandred"
                          }
                        >
                    ...
                    <ListItemIcon>
                      <IconButton
                        onClick={handleExpandButtonClick(item, 2)}
                        className={
                          selectedPromo === item.campaignID
                            ? clsx(classes.expand, {
                                [classes.expandOpen]: expanded,
                ...
                <div className="table">
                  ...
                  <div className={"rowx"}>
                    <div className={"cardsx"}>
                      ...
                      <div>
                        {" "}
                        <ScheduleIcon style={{ height: 70, width: 70 }} />
                      </div>
...
export default class HomeScreen extends React.Component {
  ...
  componentWillMount() {
    ...
    axios({
      method: "GET",
      url: `http://localhost:5000/api/campaigns`, // First page at 0
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    }).then((res) => {
