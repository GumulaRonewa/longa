      ...
      <div style={{ height: 400, width: 300 }}>
        {!payment && (
          <div>
            ...
            <StyledButton style={{ top: 10 }}>Add MoMo Wallet</StyledButton>
          </div>
        )}
        {payment && (
          <div>
            <div style={{ fontSize: 20 }}>
              Longa Money will use the bank account information Above to ensure
              you receive payment for campains you participated in. Make sure
              the details Above are correct and up to date. These details are
    ...
    <div className={"homelistdivexplore"}>
      ...
      <div className="table">
        ...
        <div className={"inputedit"}>
          ...
          <div className={"identih2"}>
            ...
            <div className={"colic"}>
              <YouTubeIcon style={{ color: red[500] }} /> 6
            </div>
          </div>
        </div>
        <div className={"inputedit"}>
      ...
      <div className={"bottomdiv"} style={{ width: "90%" }}>
        <div className={"moneyside"}>
          ...
          />
          <div className={"textmon"}>R {item.earnings}</div>
        </div>
        <div className={"groupside"}>
          <PeopleIcon
            color={"primary"}
            style={{ marginLeft: 20, height: 40, width: 30 }}
          />
          <div className={"textmon"}>{item.bids}</div>
        </div>
      </div>
    </div>
  );
